                                        ...
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                ...
                                                <div class="product-action">
                                                    <a href="{{url('user/cart')}}" class="btn-product btn-cart"><span>add to cart</span></a>
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Brown paperbag waist pencil skirt</a></h3><!-- End .product-title -->
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Dark yellow lace cut out swing dress</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $84.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Khaki utility boiler jumpsuit</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Blue utility pinafore denim dress</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $76.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Beige knitted elastic runner shoes</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $84.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Orange saddle lock front chain cross body bag</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $84.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Light brown studded Wide fit wedges</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $110.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Yellow button front tea top</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $56.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Black soft RI weekend travel bag</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $68.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Beige metal hoop tote bag</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $76.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Brown zebra print dungaree dress</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $80.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{url('user/single-shop')}}">Beige ring handle circle cross body bag</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $56.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
