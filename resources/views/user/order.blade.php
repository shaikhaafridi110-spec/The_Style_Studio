            ...
            <div class="order-card-body">
                ...
                <div class="amount-row">
                    <div>
                        ...
                        <div class="items-count">{{ $order->items->count() }} item(s) · {{ ucfirst($order->payment_method) }}</div>
                    </div>
